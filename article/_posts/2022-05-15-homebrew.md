...
~~~console
brew deps --tree --installed # Für ale installierten Pakete
brew deps --tree <paketname> # Für ein bestimmtes Paket
~~~
...
![Grafische Ausgabe der Dependencies](https://datablob.oss.eu-west-0.prod-cloud-ocb.orange-business.com/images/homebrew_07.png)
...
Was die Pakete angeht, könnte die Information, welche Pakete welche Pakete überhaupt ein Update benötigen ganz interessant sein. Dies überprüfen wir mit dem folgenden Kommando:
